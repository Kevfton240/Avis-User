...
import kongo.Avisusers.entites.Role;
import kongo.Avisusers.entites.TypeDeRole;
...
public class UtilisateurService {
    ...
    public void inscription(Utilisateur utilisateur){
       ...
       String mdpCrypte =  this.passwordEncoder.encode(utilisateur.getMdp());
        ...
        this.validationService.enreistre(utilisateur);
  ...
  Utilisateur utilisateurActiver = this.utilisateurRepository.findById(
          validation.getUtilisateur().getId()).orElseThrow(()
